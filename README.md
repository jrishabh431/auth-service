...
```sh
sls create --name auth-service --template-url https://github.com/jrishabh431/auth-service
cd auth-service
```
...
It is very easy to make your authorizer work anywhere else in your AWS account.
